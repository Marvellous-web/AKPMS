...
public class EmailUtil {
	...
	//	private static final Logger LOGGER = Logger.getLogger(EmailUtil.class);
		...
		public void sendEmail() throws Exception {
			log.info("in EmailUtil: sendEmail");
			...
			log.info("out EmailUtil: sendEmail");
		}
