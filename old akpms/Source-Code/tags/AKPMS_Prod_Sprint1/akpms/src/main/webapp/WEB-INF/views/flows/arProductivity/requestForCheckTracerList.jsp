...
<script type="text/javascript">
	...
	function formatData(data) {
		...
		$.each(data.rows, function(i, row) {
			...
			attachment = "<div class='download-container'>"+row.attachmentName+"<a class='download' href='"+contextPath+"/flows/checkTracer/fileDownload?id="+row.attachmentId+"' title='Download File'></a></div>";
			edit = "<a href='"+contextPath+"/flows/checkTracer/add/?arProductivity.id="+row.arProdId+"' class='edit'><img src='"+editIcon+"'/></a>";
			rows.push({
				id : row.id,
				cell : [ row.patientName, row.patientAccNo, row.checkNo, row.checkIssueDate, row.cashedDate, attachment, edit]
			});
		});
