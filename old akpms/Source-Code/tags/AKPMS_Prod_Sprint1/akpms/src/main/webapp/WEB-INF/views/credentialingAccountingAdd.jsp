	...
	<form:form commandName="credentialingAccounting" id="form1" class="form-container">
		<div class="form-container-inner">
			...
			<span class="input-container">
				...
				<span class="input_text">
					<span class="left_curve"></span>
						<form:input path="dateRecd" maxlength="200" cssClass="mid" cssStyle="width: 100px;"  readonly="true"/>
			...
			<span class="input-container">
				...
				<span class="input_text">
					<span class="left_curve"></span>
						<form:input path="taskCompleted" maxlength="200" cssClass="mid" cssStyle="width: 100px;" readonly="true" />
					<span class="right_curve"></span>
				</span>
			...
			<span class="input-container">
				...
				<span class="input_text">
					<span class="left_curve"></span>
						<form:input path="time" maxlength="200" cssClass="mid" cssStyle="width: 100px;"  />
					<span class="right_curve"></span>
				</span>
