		...
		<div class="form-container-inner">
			...
			<div class="row-container">
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text"  id="dateReceivedFrom" name="dateReceivedFrom" maxlength="6" class="mid" style="width: 100px;" readonly/>
						<span class="right_curve"></span>
					</div>
				</div>
				...
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text" id="dateReceivedTo" name="dateReceivedTo" maxlength="6" class="mid" style="width: 100px;" readonly />
						<span class="right_curve"></span>
					</div>
				</div>
				<div class="clr"></div>
...
var contextPath = "<c:out value="${pageContext.request.contextPath}" />";
	...
	function formatData(data) {
		...
		$.each(data.rows,function(i, row) {
            ...
            rows.push({
					id : row.id,
					cell : [ row.credentialingTask, row.dateRecd,row.taskCompleted,row.time,row.postedBy,row.remark,edit ]
				});
			});
