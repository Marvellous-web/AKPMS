...
<head>
	...
	<link rel="stylesheet" type="text/css"
		href="<c:url value="/static/resources/css/flexigrid.css"/>" />

	<link rel="stylesheet" type="text/css"
		href="<c:url value="/static/resources/css/popupstyle.css"/>" />

	<link rel="stylesheet" type="text/css"
		href="<c:url value="/static/resources/css/rating.css"/>" />

	<link rel="stylesheet" type="text/css"
		href="<c:url value="/static/resources/css/forms.css"/>" />

     <link rel="stylesheet" type="text/css"
		href="<c:url value="/static/resources/css/jquery-ui.css"/>" />
	...
	<script type="text/javascript"
		src="<c:url value='/static/resources/js/forms.js'/>"></script>

	<script type="text/javascript"
		src="<c:url value='/static/resources/js/flexigrid/flexigrid.js'/>"></script>

	<script type="text/javascript"
		src="<c:url value='/static/resources/js/jquery.rating.js'/>"></script>

	<script type="text/javascript"
		src="<c:url value='/static/resources/js/jquery.bpopup-0.7.0.min.js'/>"></script>

	<script type="text/javascript"
		src="<c:url value='/static/resources/js/jquery-ui.js'/>"></script>

	<script type="text/javascript"
		src="<c:url value='/static/resources/js/jquery.limit.js'/>"></script>
