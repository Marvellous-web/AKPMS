		...
		<div class="table-grid" id="divMultiple">
			<table class="dd" width="100%" id="data" border = "2">
				...
				<c:forEach var="postingRecords" items="${postingRecord}"
					...
					<tr id="row_${i.index }">
						<td>
							<form:input path="postingRecords[${i.index }].cpt" id="postingRecords_${i.index }_cpt" maxlength="100"/>
						</td>
						<td>
			...
			<div class="row-container">
				<label>&nbsp;</label>
				<input type="submit" title="${operationType} ${buttonName}" value="${operationType} ${buttonName}"  class="login-btn" />
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#addnew').click(function(){
			...
			+'<td><input type = "text" name = "postingRecords['+currentItem+'].cpt" id="postingRecords_'+currentItem+'_cpt" maxlength="100"/></td>'
