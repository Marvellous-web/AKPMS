...
public class PaymentERAValidator extends LocalValidatorFactoryBean implements
	...
	private static final Logger LOGGER = Logger
			.getLogger(PaymentERAValidator.class);
	...
	public void validate(Object target, Errors errors) {
		...
		try {
			...
			Matcher stringNameMatcher = stringPattern
					.matcher(paymentProductivity.getChkNumber());
			...
			try {
				isExist = paymentProductivityDao
						.findByTicketNo(paymentProductivity.getPaymentBatch()
								.getId());
			...
			if (isExist != null & paymentProductivity.getId() == null) {
				...
				errors.rejectValue("paymentBatch.id",
						"paymentBatch.id.duplicate");
			}
		} catch (Exception e) {
