...
public class UserDaoImpl implements UserDao {
	...
	@Override
	public User findById(Long id, boolean dependancies) throws ArgusException {
		...
		if (user != null && dependancies) {
			...
			Hibernate.initialize(user.getEmailTemplate());
		}
	...
	public User findByEmail(String email, boolean loadDependacies)
		...
		try {
			...
			if (userDB != null && loadDependacies) {
				...
				Hibernate.initialize(userDB.getEmailTemplate());
			}
			return userDB;
		} catch (Exception e) {
	...
	@Override
	public List<User> findAll(String orderBy) throws ArgusException {
	...
	@Override
	public void register(User user) throws ArgusException {
		// em.persist(user);
		em.merge(user);
		return;
	}
	...
	@Override
	public void updateUser(User user) throws ArgusException {
		em.merge(user);
	}
	...
	@Override
	public int resetPassword(long id) throws ArgusException {
		Query query = em.createQuery(RESET_PASSWORD);

		PasswordEncoder encoder = new Md5PasswordEncoder();
		query.setParameter("password",
				encoder.encodePassword("login@123", Constants.SALT));
		query.setParameter("modifiedBy", AkpmsUtil.getLoggedInUser());
		query.setParameter("modifiedOn", new Date());
		query.setParameter("id", id);
	...
	@Override
	public List<Object[]> getUserStats() throws ArgusException {
	...
	@Override
	public void insertLoginDetails(Long userid) throws ArgusException {
	...
	@Override
	public String getLastLoginDetails(Long userId) throws ArgusException {
	...
	@Override
	public List<User> getUserByDept() throws ArgusException {
	...
	@Override
	public List<User> getOffsetUser() throws ArgusException {
		List<User> userList = null;
		CriteriaBuilder builder = em.getCriteriaBuilder();
		CriteriaQuery<User> userCriteriaQuery = builder.createQuery(User.class);
		Root<User> from = userCriteriaQuery.from(User.class);
