	...
	<form:form commandName="paymentProductivityRefundRequest" id="form1" class="form-container" onsubmit="return checkDetails();">
		...
		<div class="row-container">
			...
			<div class="element-block" >
				...
				<div class="input_text">
					<span class="left_curve"></span>
					<form:input path="transactionDate" cssClass="mid" cssStyle="width: 75px;"  readonly="true"/>
					<span class="right_curve"></span>
				</div>
			...
			<div class="row-container">
				...
				<div class="input_text">
					<span class="left_curve"></span>
					<form:input path="requestDate" cssClass="mid" cssStyle="width: 75px;"  readonly="true"/>
					<span class="right_curve"></span>
				</div>
