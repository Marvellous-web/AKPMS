	...
	<form:form commandName="chargeBatchProcess" id="form1" class="form-container">
		<div class="form-container-inner">
			...
			<div class="row-container">
				...
				<div>
					<form:select path="receivedBy.id" cssClass="selectbox">
			...
			<div class="row-container">
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<form:input path="dateBatchPostedFrom" readonly="true"  cssClass="mid" cssStyle="width: 90px;" />
						<span class="right_curve"></span>
					</div>
				...
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<form:input path="dateBatchPostedTo" readonly="true"  cssClass="mid" cssStyle="width: 90px;"  />
						<span class="right_curve"></span>
					</div>
