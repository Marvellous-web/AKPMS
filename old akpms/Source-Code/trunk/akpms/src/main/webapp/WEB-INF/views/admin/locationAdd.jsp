	...
	<div id="bread-crumb">
		<ul>
			...
			<li><a href="<c:url value='/admin/location' />">&nbsp;Location List</a>
				&raquo;</li>
			<li>&nbsp;${operationType} Location</li>
		</ul>
	</div>
	<div class="clr"></div>
	<!-- Bread Crumb End-->
	<form:form commandName="location" id="form1" class="form-container">
		<div class="form-container-inner">
			<h3>${operationType} Location</h3>
			...
			<span class="input-container"> <label>&nbsp;</label>
				<input type="submit" title="Save / Update Location" value="${buttonName}" class="login-btn" /> 
	...
	function deleteLocation(id) {
		if (confirm("Are you sure you wish to delete this location?")) {
			$.ajax({
				type : "POST",
				dataType : "json",
				url : contextPath + "/admin/location/delete",
				data : "items=" + id,
				success : function(data) {
					window.location.href= contextPath + '/admin/location?successUpdate=location.deletedSuccessfully ';
				}
			});
		}
	}
