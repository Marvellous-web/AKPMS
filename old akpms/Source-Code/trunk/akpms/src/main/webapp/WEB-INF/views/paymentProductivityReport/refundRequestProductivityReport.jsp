		...
		<div class="form-container-inner">
			...
			<div class="row-container">
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text"  id="dateTransactionFrom" name="dateTransactionFrom" class="mid" style="width: 100px;" readonly="readonly"/>
						<span class="right_curve"></span>
					</div>
				</div>
				...
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text" id="dateTransactionTo" name="dateTransactionTo"  class="mid" style="width: 100px;" readonly="readonly" />
						<span class="right_curve"></span>
					</div>
				</div>
				<div class="clr"></div>
           ...
           <div class="row-container">
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text"  id="dateResolutionFrom" name="dateResolutionFrom" class="mid" style="width: 100px;" readonly="readonly"/>
						<span class="right_curve"></span>
					</div>
				</div>
				...
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input type = "text" id="dateResolutionTo" name="dateResolutionTo"  class="mid" style="width: 100px;" readonly="readonly" />
						<span class="right_curve"></span>
					</div>
				</div>
				<div class="clr"></div>
