...
<div class="dashboard-container">
	<!-- Bread Crumb Start-->
	<div id="bread-crumb" class="bread-crumb">
		<ul>
		...
		<div class="section-content">
			...
			<div class="row-container">
		    	<div class="element-block" >
			    	<span  class="lbl">Ticket/Batch No:</span> <span style="font-size: 20px;">${paymentBatch.id}</span>
			    </div>
		    	<div class="clr"></div>
		    </div>
			...
			<div class="row-container">
			    ...
			    <div class="element-block" >
			    	<span class="lbl">Group/Doctor Name:</span> 
			    	<span>
			    	<c:if test="${paymentBatch.doctor.nonDeposit}">
			    	${paymentBatch.doctor.name} (Non-Deposit)
			    	</c:if>
			    	<c:if test="${!paymentBatch.doctor.nonDeposit}">
			    	${paymentBatch.doctor.name}
			    	</c:if>
			    	</span>
			    </div>
		    	<div class="clr"></div>
		    ...
		    <div class="row-container">
			    ...
			    <div class="element-block" >
			    	<span class="lbl">PH Doctor Name:</span> <span>${paymentBatch.phDoctor.name}</span>
			    </div>
		    	<div class="clr"></div>
		    </div>
		    ...
		    <div class="row-container">
		    	<div class="element-block" >
			    	<span class="lbl">Money Source:</span> <span>${paymentBatch.moneySource.name}</span>
			    	<%-- <div>
		    ...
		    <div class="row-container">
			    ...
			    <div class="element-block" >
			    	<span  class="lbl">Agency Money:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency" value="${paymentBatch.agencyMoney}" /></span>
			    </div>
		    	<div class="clr"></div>
		    </div>
		    ...
		    <div class="row-container">
		    	<div class="element-block" >
			    	<span  class="lbl">Deposit Amount (In USD):</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency" value="${paymentBatch.depositAmount}" /></span>
			    </div>
			    <div class="element-block" >
			    	<span  class="lbl">OLD Prior AR:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency" value="${paymentBatch.oldPriorAr}" /></span>
			    </div>
		    	<div class="clr"></div>
		    </div>
		    ...
		    <div class="row-container">
		    	<div class="element-block" >
			    	<span class="lbl">NDBA (In USD):</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency"  value="${paymentBatch.ndba}" /></span>
			    </div>
			    
		    	<div class="element-block" >
			    	<span  class="lbl">CT Posted Total:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency" value="${paymentBatch.ctPostedTotal}" /></span>
			    </div>
		    	<div class="clr"></div>
		    </div>
		    ...
		    <div class="row-container">
		    	<div class="element-block" >
			    	<span class="lbl">Other Income:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency"  value="${paymentBatch.otherIncome}" /></span>
			    </div>
		    	<div class="element-block">
			    	<span  class="lbl">+/- Posting:</span> <span><fmt:formatNumber type="currency" pattern="$#,##0.00;-$#,##0.00" value="${plusMinusPosting}" /></span>
			    </div>
		    	<div class="clr"></div>
		    </div>
		    ...
		    <div class="row-container">
		    	<div class="element-block" >
			    	<span  class="lbl">NSF/Sys Ref:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency"  value="${paymentBatch.nsfSysRef}" /></span>
			    </div>
			    <div class="element-block" >
			    	<span  class="lbl">Suspense Account:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency"  value="${paymentBatch.suspenseAccount}" /></span>
			    </div>
		    	<div class="clr"></div>
		    </div>
			...
			<div class="row-container">
				...
				<div class="element-block">
					<span class="lbl">Offset:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00" type="currency"  value="${paymentBatch.offsetMinus}" /></span>
				</div>
				<div class="clr"></div>
			</div>
			...
			<div class="row-container">
			    <div class="element-block" >
			    	<span class="lbl">Refund Chk:</span> <span><fmt:formatNumber pattern="$#,##0.00;-$#,##0.00"  type="currency"  value="${paymentBatch.refundChk}" /></span>
			    </div>
			...
			<c:if test="${not empty paymentBatch.revisedBy}">
				<div class="row-container">
					<div class="element-block">
						<span class="lbl">Revised By:</span> <span>${paymentBatch.revisedBy.firstName}&nbsp;${paymentBatch.revisedBy.lastName}</span>
					</div>
					<div class="element-block">
				...
				<div class="form-container-inner">
					...
					<div class="row-container">
						...
						<div class="element-block">
							...
							<div class="input_text">
								<span class="left_curve"></span>
								<form:input path="otherIncome" maxlength="15" cssClass="mid numbersOnly" cssStyle="width: 100px;"	 />
								<span class="right_curve"></span>
							</div>
					...
					<div class="row-container">
						...
						<div class="element-block">
							...
							<div class="input_text">
								<span class="left_curve"></span>
								<form:input path="oldPriorAr" maxlength="15" cssClass="mid numbersOnly" cssStyle="width: 100px;" />
								<span class="right_curve"></span>
							</div>
					...
					<div class="row-container">
						...
						<div class="element-block">
							...
							<div class="input_text">
								<span class="left_curve"></span>
								<form:input path="datePosted" cssClass="mid" cssStyle="width: 100px;" readonly="true" />
								<span class="right_curve"></span>
							</div>
					...
					<div class="row-container">
						...
						<div class="element-block">
							<form:label path="datePosted">Posted On:<em class="mandatory">*</em></form:label>
							<div class="input_text">
								<span class="left_curve"></span>
								<form:input path="postedOn" cssClass="mid" cssStyle="width: 100px;" readonly="true" />
								<span class="right_curve"></span>
							</div>
							<form:errors class="invalid" path="postedOn" />
						</div>
						<div class="clr"></div>
					</div>
					...
					<div class="row-container">
						<div class="element-block">
							...
							<span>
								${paymentBatch.createdBy.firstName}&nbsp;${paymentBatch.createdBy.lastName}	 On <fmt:formatDate value="${paymentBatch.createdOn}" pattern="MM/dd/yyyy"/>
							</span>
							
							<c:if test="${not empty paymentBatch.revisedBy}">
								<br />
								<span class="lbl">Last Revised By:</span> 
								<span>
									${paymentBatch.revisedBy.firstName}&nbsp;${paymentBatch.revisedBy.lastName} On <fmt:formatDate value="${paymentBatch.revisedOn}" pattern="MM/dd/yyyy"/>
								</span>
							</c:if>
							
							<c:if test="${not empty paymentBatch.reUpdatedBy}">
								<br />
								<span class="lbl">RE-Update By:</span> 
								<span>
									${paymentBatch.reUpdatedBy.firstName}&nbsp;${paymentBatch.reUpdatedBy.lastName} On <fmt:formatDate value="${paymentBatch.reUpdatedOn}" pattern="MM/dd/yyyy"/>
								</span>
							</c:if>							
						</div>
						<div class="clr"></div>
					...
					<div class="row-container">
						<label>&nbsp;</label>
							<input type="submit" title="${updateOrReupdate}"  value="${updateOrReupdate}" class="login-btn" />
...
<script type="text/javascript">
	...
	function checkDepositAmt() {
		if ((addFloats($('#manuallyPostedAmt').val(), $('#elecPostedAmt').val())) > (addFloats($('#hidDepositAmt').val(), $('#hidNDBA').val()))) {
	...
	function totalCTPosted() {
		...
		totalCTPostedAmt = addFloats(manuallyPostedAmt, elecPostedAmt);
		...
		if (isNaN(depositAmount)) {
			...
			if (amount == 0) {
				...
				depositAmount = parseFloat('${paymentBatch.depositAmount}')
						.toFixed(2);
			}
		}
		$('#plusMinusPosting').html(
				"<strong>$"
						+ parseFloat(depositAmount - totalCTPostedAmt).toFixed(
								2) + "</strong>");
		$('#spnCTTotalPosted').html(
				"<strong>$" + parseFloat(totalCTPostedAmt).toFixed(2)
						+ "</strong>");
	}
	totalCTPosted();
</script>
