		...
		<div class="form-container-inner">
			...
			<div class="row-container">
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input name="dateCreatedFrom" id="dateCreatedFrom" type="text"  readonly="readonly" class="mid" style="width: 90px;" />
						<span class="right_curve"></span>
					</div>
				</div>
				<div class="element-block" >
					...
					<div class="input_text">
						<span class="left_curve"></span>
						<input name="dateCreatedTo" type="text" id="dateCreatedTo" readonly="readonly" class="mid" style="width: 90px;"  />
						<span class="right_curve"></span>
					</div>
				</div>
				<div class="clr"></div>
