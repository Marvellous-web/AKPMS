			...
			<div id="right-side">
				...
				<div class="dashboard-heading-container">
					...
					<div class="search-box">
							<input type="text" id="search_value" maxlength="50" onkeypress="pressEnter(event)" title="Search Process Manual"/>
							<input type="submit" title="Click to go" value="" onclick=" search(); " />
					</div>
					
					<script type="text/javascript">
						function search(){
							var kwd = document.getElementById("search_value");
							window.find(kwd.value, false, false, true,
						            false, false, false); 
							window.find(kwd.value, false, false, true,
						            false, false, false);
							}
