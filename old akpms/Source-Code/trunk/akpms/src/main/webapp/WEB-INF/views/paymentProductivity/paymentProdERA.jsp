...
<div class="dashboard-container">
	...
	<form:form commandName="paymentProductivity" id="form1">
		<div class="form-container" id="divProductivityForm">
			...
			<div class="row-container">
				<div class="element-block" >
					<label>Total Posted Amount:<br/>&nbsp;&nbsp;(in USD)</label>
			...
			<div class="row-container">
				...
				<input type="submit" title="Save / Update Insurance" value="${buttonName}" class="login-btn" onclick="javascript:disabledButtons();this.form.submit();"/>
