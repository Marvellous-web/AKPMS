		...
		<div class="form-container-inner">
			...
			<span class="input-container">
				<c:forEach var="role" items="${roles}">
					<form:checkbox path="role.id" value="${role.id}" onclick="showHidePermissions(this);" cssClass="unique" />	${role.name} &nbsp;&nbsp;
				</c:forEach>
				...
				<div class="input-container">
					<ul class="profile-ul">
						<c:forEach var="permission" items="${permissions}">
							<li><form:checkbox path="permissions" value="${permission}" /><span class="dept-heading">${permission.name}</span></li>
							<li class="perm-desc" >${permission.desc}</li>
						</c:forEach>
					</ul>
				</div>
				<br /> <br />
...
<script type="text/javascript">
	...
	function showHidePermissions(chk){
		if(chk.checked && chk.value == '${traineeUserRole}'){
