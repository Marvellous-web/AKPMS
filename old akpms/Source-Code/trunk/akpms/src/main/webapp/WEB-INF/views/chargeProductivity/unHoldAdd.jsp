	...
	<div class="section-content">
		...
		<div class="row-container">
			<div class="element-block">
				<span  class="lbl">Provider Name:</span> <span id="providerName">
					${chargeProductivity.ticketNumber.doctor.name}
		...
		<%-- <div class="row-container">
			<div class="element-block">
				<span  class="lbl">Posting Date:</span> <span id="postDate"><fmt:formatDate value="${chargeProductivity.ticketNumber.dateBatchPosted}" pattern="MM/dd/yyyy"/></span>
			</div>
			<div class="clr"></div>
		</div> --%>
		<div class="row-container">
				...
				<c:choose>
					<c:when test="${readOnly != 'readOnly'}">
						<div class="row-container">
							...
							<div class="clr"></div>
							<span class="invalid" id='errUnholdRemarks' style="display:none;" >Unhold remarks cannot be left blank.</span>
							<div class="clr"></div>
						</div>
						...
						<div class="row-container">
							<label>&nbsp;</label>
							<input type="button" title="Done" value="Done" class="login-btn"  onclick="validate();" />
							<div class="clr"></div>
						</div>
					</c:when>
					<c:otherwise>
...
<!--
function validate(){
	if($.trim($("#unholdRemarks").val()) == ""){
		$("#errUnholdRemarks").css("display","block");
		return false;
	}else{
		$("#errUnholdRemarks").css("display","none");
		$("#form1").submit();
	}
}
//-->
