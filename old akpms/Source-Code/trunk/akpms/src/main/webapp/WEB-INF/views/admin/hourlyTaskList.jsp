...
<div class="dashboard-container">
	...
	<form class="form-container" id="hourlyTaskList">
		<div class="form-container-inner">
			<h3>Search Hourly Task</h3>
...
<script type="text/javascript">
	...
	function addFormData() {
		...
		var dt = $('#hourlyTaskList').serializeArray();
		$("#flex1").flexOptions({
			params : dt
		});
		return true;
	...
	$('#hourlyTaskList').submit(function() {
		$('#flex1').flexOptions({
			newp : 1
		}).flexReload();
		return false;
...
//				del = "<a href='javascript:void(0)' onClick='send_delete(" + row.id + ")' class='delete'><img src='"+deleteIcon+"' alt='Delete' title='Delete' /></a>";
				...
				rows.push({
					id : row.id,
					cell : [edit, row.name, row.chargeable, row.department, row.desc]
				});
			});
