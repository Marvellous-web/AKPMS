...
//						$(tdDiv).css('white-space', 'pre');
		...
		if (p.colModel) { //create model if any
			...
			for (var i = 0; i < p.colModel.length; i++) {
				var cm = p.colModel[i];
				 // Fix problem with looping in IE
		        if (undefined === cm)
		            break;
		...
		if (p.usepager) {
			...
			if (p.useRp) {
				...
				$('.pDiv2', g.pDiv).prepend("<div class='pGroup'><select name='rp' id='rp' style='width:auto!important;' >" + opt + "</select></div> <div class='btnseparator'></div>");
