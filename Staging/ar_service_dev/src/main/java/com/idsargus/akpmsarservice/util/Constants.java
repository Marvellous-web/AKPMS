...
public final class Constants {
	...
	public static final String CREATEDDATEFROM = "createdDateFrom";
	public static final String CREATEDDATETO = "createdDateTo";
	public static final String FOLLOWUPDATEFROM = "followUpDateFrom";
	public static final String FOLLOWUPDATETO = "followUpDateTo";
	...
	public static final Integer PROCESS_MANUAL_MODIFICATION_MAIL_TEMPLATE = 6;


	public static final Integer PROCESS_MANUAL_MODIFICATION_SUBSCRIPTION_MAIL_TEMPLATE = 1;

	public static final Integer PROCESS_MANUAL_EMAIL_SUBSCRIPTION_MAIL_TEMPLATE = 7;
	...
	public static final String DEPENDANCY_FILES = "uploads";
	...
	public static final String SITE_URL = "http://192.168.20.153/akpmsui/#/login";
   ...
   // public static final String RETURN_TO_AR = "Return to AR";
    ...
    public static final String BACK_TO_TEAM = " Back To Team";
